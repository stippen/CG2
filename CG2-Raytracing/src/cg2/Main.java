...
public class Main {
	public static void main(String[] args) {
		...
		scene.addShape(new Sphere(new Vector(1.0f, 0.0f, -2.0f), 0.5f, new Color(1, 0, 0)));
		scene.addShape(new Sphere(new Vector(1.0f, 0.0f, -5.0f), 0.5f, new Color(0, 0, 1)));
		scene.addShape(new Sphere(new Vector(-0.6f, 0.6f, -2.0f), 0.6f, new Color(0, 1, 0)));	
		scene.addShape(new Sphere(new Vector(0.0f, 0.0f, 1.0f), 0.1f, new Color(1, 1, 0)));
		...
		scene.addShape(new Triangle(new Vector(2.0f, 1.0f, -3.0f), new Vector(2.3f, 1.0f, -3.0f), new Vector(2.0f, 1.3f, -2.0f), new Color(0.4f, 0.4f, 0)));
		...
		String path = new String("../Übungsbilder");
